...
const AddATravel = () => {
  ...
  return (
    <View style={[styles.addATravel, styles.addATravelLayout]}>
      <Image
        style={styles.unionIcon}
        resizeMode="cover"
        source={require("../assets/union.png")}
      />
      <View style={[styles.findAStudent, styles.wrapperPosition]}>
...
You are a                :`}</Text>
          ...
          <View style={[styles.frontContent, styles.frontContentLayout]}>
            <View
              style={[styles.frontContentChild, styles.frontContentLayout]}
            />
            <Text
              style={[styles.findAStudent1, styles.textTypo]}
